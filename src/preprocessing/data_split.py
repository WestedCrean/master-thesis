...
def log_split_to_wandb(split: str, img_filenames: list):
    run = wandb.init(project="master-thesis", job_type="data_split", entity=f"{split}_upload")
...
def data_split():
    ...
    for l in labels:
        ...
        train_filenames, val_filenames = train_test_split(train_filenames, test_ratio=0.125)
